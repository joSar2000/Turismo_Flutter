...
class TurismTable16State extends State<TurismTable16> {
  ...
  String nombres = obs_nombres.text;
  String institucion = obs_institucion.text;
  String cargo = obs_cargo.text;
  String email = obs_email.text;
  String telefono = obs_telef.text;
  String firma = obs_firma.text;
