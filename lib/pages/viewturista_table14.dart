...
class FormWidgetState14 extends State<TurismTable14>  {
  ...
  static TextEditingController obs_fuente_anexos = TextEditingController();

  String fuente_anexos = obs_fuente_anexos.text;
                ...
                return Center(
                  child: Column(
                    children: [
                      ...
                      if(viewModel.image!=null)
                        Image.file(viewModel.image,height: 250),
                      Row(
                      ...
                      new Column(
                        children: <Widget> [
                          if(viewModel.image2==null)
                            Icon(Icons.camera,size: 70),
                          if(viewModel.image2!=null)
                            Image.file(viewModel.image2,height: 250),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                            children: <Widget> [
                              Flexible(
                      ...
                      new Container(
                        child: Text(
                            "Una vez haya seleccionado sus imágenes, "
                            "pulse el botón de abajo. Caso contrario, sus imágenes "
