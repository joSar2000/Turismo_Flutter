...
class FormWidgetState12 extends State<TurismTable12> {
  static TextEditingController obs_personas_administracion =
      TextEditingController();
  static TextEditingController obs_personas_especializadas =
      TextEditingController();
  static TextEditingController obs_personas_primaria = TextEditingController();
  static TextEditingController obs_personas_secundaria =
      TextEditingController();
  static TextEditingController obs_personas_tercer_nivel =
      TextEditingController();
  static TextEditingController obs_personas_cuarto_nivel =
      TextEditingController();
  static TextEditingController obs_personas_primeros_auxilios =
      TextEditingController();
  static TextEditingController obs_personas_hospitalidad =
      TextEditingController();
  static TextEditingController obs_personas_atencion_cliente =
      TextEditingController();
  static TextEditingController obs_personas_guianza = TextEditingController();
  static TextEditingController obs_personas_discapacidades =
      TextEditingController();
  static TextEditingController obs_personas_capacitadas_otros =
      TextEditingController();
  ...
  static TextEditingController obs_personas_idioma_otro =
      TextEditingController();
                      ...
                      children: <Widget>[
                        ...
                        TextFormField(
                          ...
                          enabled: this.recurso_humano_si &&
                              this.personas_administracion_si,
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: "Especifique número de personas",
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        TextFormField(
                          keyboardType: TextInputType.number,
                          enabled: this.recurso_humano_si &&
                              this.personas_especializadas_si,
                          ...
                          child: Form(
                            child: Column(
                              children: <Widget>[
                                ...
                                TextFormField(
                                  enabled: this.recurso_humano_si &&
                                      this.personas_nivel_instruccion,
                ...
                new Row(
                  ...
                  children: <Widget>[
                    Flexible(
                      child: Container(
                        child: Container(
                            child: Text("Sensibilización de discapacidades",
                                style: GoogleFonts.dmSans(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 18,
                                  color: HexColor("#364C59"),
    ...
    Navigator.push(
        ...
        MaterialPageRoute(
            builder: (context) => TurismTable13(
              ...
              personas_ingles: personas_ingles,
                recurso_humano_si: recurso_humano_si,
              personas_especializadas_si: personas_especializadas_si,
                recurso_humano_no: recurso_humano_no,
                recurso_humano_s_i: recurso_humano_s_i,
                personas_administracion_si: personas_administracion_si,
              personas_nivel_instruccion: personas_nivel_instruccion,
                personas_capacitadas: personas_capacitadas,
                personas_idiomas: personas_idiomas,
                personas_administracion: personas_administracion,
                personas_especializadas: personas_especializadas,
                personas_primaria: personas_primaria,
                personas_secundaria: personas_secundaria,
                personas_tercer_nivel: personas_tercer_nivel,
                personas_cuarto_nivel: personas_cuarto_nivel,
                personas_primeros_auxilios: personas_primeros_auxilios,
                personas_hospitalidad: personas_hospitalidad,
                personas_atencion_cliente: personas_atencion_cliente,
                personas_guianza: personas_guianza,
                personas_discapacidades: personas_discapacidades,
                personas_capacitadas_otros: personas_capacitadas_otros,
              personas_aleman: personas_aleman,
                personas_frances: personas_frances,
                personas_italiano: personas_italiano,
